...
CREATE UNIQUE INDEX `linkedin_UNIQUE` ON `referral`.`candidate` (`linkedin` ASC);

CREATE INDEX `stage_idx` USING BTREE ON `referral`.`candidate` (`stage`);

CREATE INDEX `status_idx` USING BTREE ON `referral`.`candidate` (`status`);

CREATE INDEX `fk_candidate_coordinator1_idx` ON `referral`.`candidate` (`coordinator_id` ASC);

CREATE UNIQUE INDEX `email_UNIQUE` ON `referral`.`candidate` (`email` ASC);

CREATE UNIQUE INDEX `phone_UNIQUE` ON `referral`.`candidate` (`phone` ASC);
...
CREATE INDEX `fk_candidate_has_participation_participation1_idx` ON `referral`.`candidate_participation` (`participation_id` ASC);

CREATE INDEX `fk_candidate_participation_candidate1_idx` ON `referral`.`candidate_participation` (`candidate_id` ASC);

CREATE INDEX `fk_candidate_participation_referrer1_idx` ON `referral`.`candidate_participation` (`referrer_id` ASC);
...
CREATE INDEX `fk_skill_has_candidate_skill1_idx` ON `referral`.`candidate_skill` (`skill_id` ASC);

CREATE INDEX `fk_candidate_skill_candidate1_idx` ON `referral`.`candidate_skill` (`candidate_id` ASC);
...
CREATE INDEX `industry_idx` USING BTREE ON `referral`.`company` (`industry`);

CREATE INDEX `city_idx` USING BTREE ON `referral`.`company` (`city`);

CREATE UNIQUE INDEX `name_UNIQUE` ON `referral`.`company` (`name` ASC);

CREATE UNIQUE INDEX `careerlink_UNIQUE` ON `referral`.`company` (`careerlink` ASC);
...
CREATE UNIQUE INDEX `email_UNIQUE` ON `referral`.`coordinator` (`email` ASC);

CREATE UNIQUE INDEX `phone_UNIQUE` ON `referral`.`coordinator` (`phone` ASC);
...
CREATE INDEX `fk_engagement_candidate1_idx` ON `referral`.`engagement` (`candidate_id` ASC);

CREATE INDEX `fk_engagement_coordinator1_idx` ON `referral`.`engagement` (`coordinator_id` ASC);
...
CREATE INDEX `fk_experience_candidate1_idx` ON `referral`.`experience` (`candidate_id` ASC);
...
CREATE INDEX `fk_candidate_has_company_company1_idx` ON `referral`.`job` (`company_id` ASC);

CREATE INDEX `fk_job_candidate1_idx` ON `referral`.`job` (`candidate_id` ASC);

CREATE INDEX `fk_job_referrer1_idx` ON `referral`.`job` (`referrer_id` ASC);
...
CREATE INDEX `fk_note_candidate1_idx` ON `referral`.`note` (`candidate_id` ASC);

CREATE INDEX `fk_note_coordinator1_idx` ON `referral`.`note` (`coordinator_id` ASC);
...
CREATE TABLE IF NOT EXISTS `referral`.`participation` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL COMMENT '‘Refer\'\n\'Resume revision\'\n\'Coaching session\'\n\'Career guidance\'\n‘Interview tips\'\n\'Mock interview’',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;

CREATE UNIQUE INDEX `name_UNIQUE` ON `referral`.`participation` (`name` ASC);
...
CREATE INDEX `fk_referer_has_participation_participation1_idx` ON `referral`.`referer_participation` (`participation_id` ASC);

CREATE INDEX `fk_referer_participation_referrer1_idx` ON `referral`.`referer_participation` (`referrer_id` ASC);
...
CREATE INDEX `fk_referer_company1_idx` ON `referral`.`referrer` (`company_id` ASC);

CREATE UNIQUE INDEX `email_UNIQUE` ON `referral`.`referrer` (`email` ASC);

CREATE UNIQUE INDEX `phone_UNIQUE` ON `referral`.`referrer` (`phone` ASC);
...
CREATE INDEX `fk_resume_candidate1_idx` ON `referral`.`resume` (`candidate_id` ASC);
...
CREATE UNIQUE INDEX `skill_UNIQUE` ON `referral`.`skill` (`skill` ASC);
