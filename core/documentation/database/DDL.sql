...
CREATE UNIQUE INDEX `email_UNIQUE` ON `referral`.`candidate` (`email` ASC) VISIBLE;

CREATE UNIQUE INDEX `phone_UNIQUE` ON `referral`.`candidate` (`phone` ASC) VISIBLE;
...
CREATE UNIQUE INDEX `email_UNIQUE` ON `referral`.`coordinator` (`email` ASC) VISIBLE;

CREATE UNIQUE INDEX `phone_UNIQUE` ON `referral`.`coordinator` (`phone` ASC) VISIBLE;
...
CREATE UNIQUE INDEX `email_UNIQUE` ON `referral`.`referrer` (`email` ASC) VISIBLE;

CREATE UNIQUE INDEX `phone_UNIQUE` ON `referral`.`referrer` (`phone` ASC) VISIBLE;
